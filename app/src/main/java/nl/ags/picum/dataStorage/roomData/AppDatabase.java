...
@Database(entities = {Route.class, Sight.class, Waypoint.class, RouteWaypointCrossRef.class, CurrentLocation.class, CalculatedWaypoint.class}, version = 1)
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract CalculatedWaypointDAO calculatedWaypointDAO();
}
