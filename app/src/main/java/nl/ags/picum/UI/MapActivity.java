...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mapViewModel.getRawRoute().observe(this, this::setPointsInMap);
    ...
    private void onSightsChanged(Map<Sight, Point> sights) {
        ...
        Log.d("TAG", "Sights updated: " + sights);
    }
    ...
    public void setPointsInMap(List<Waypoint> points) {
        ...
        ArrayList<GeoPoint> waypoints = new ArrayList<>(converWayPointToGeoPoint(points));
...
//            nodeIcon.setHotspot(0.5f, 0.5f);
    ...
    public List<GeoPoint> converWayPointToGeoPoint(List<Waypoint> points) {
        List<GeoPoint> geoPoints = new ArrayList<>();
